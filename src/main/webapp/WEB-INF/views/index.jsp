			...
			<a href="dologin"> <img src="images/show-case.png" /> </a>
				...
				<div class="left-column border-box">
					<div class="news-and-event">
						...
						<ul>
								<li>
									<h3>IIT-B Alumni Meet Focuses On Economic Crisis</h3>
									<p>The Student Alumni Meet (SAM) at IIT-Bombay concluded on 6th October with students deliberating ... </p>
								</li>
								<li>
									<h3>Linkalma Welcomes You To Its Beta Version </h3>
									<p>Dear friends; it is our pleasure to launch a beta version of LinkAlma, an alumni engagement porta... </p>
								</li>
						</ul>
