...
public class ApplicationConstants {
	...
	public static String GET_SCHOOL_CURRICULUM_DATA = "SELECT S.SCHOOLID, SD.ID, S.SCHOOLNAME, SD.TITLE, CODES.PRIMARYDECODE AS TYPE ,"
	...
	public static String GET_SCHOOL_UPDATES = "SELECT SU.SCHOOLID, SU.SCHOOLUPDATESID, S.SCHOOLNAME, SU.TITLE, "
			+ " CODES.PRIMARYDECODE AS TYPE, SU.DESCRIPTION, SU.CREATEDTTM"
			+ " FROM SCHOOL S, SCHOOLUPDATES SU, STATICCODES CODES "
			+ " WHERE S.SCHOOLID = SU.SCHOOLID AND CODES.CODE = SU.TYPE AND SU.SCHOOLID = ? AND CODES.CATEGORYID = ?";
