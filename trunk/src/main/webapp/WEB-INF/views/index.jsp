...
<div id="top-bar">
	<div class="top-navigation fl">
		<ul><li><a href="contact.html">Contact Us</a></li><li><a href="whyus.html"> Why Us </a></li><li><a href="aboutus.html">About Us</a></li></ul>
	</div>
				...
				<div class="sign-in-wrapper">
					...
					<form:form action="login" modelAttribute="loginForm" >
						<ul>
							...
							<li> <input type="button" value="Sign In" id="sign-in-button" class="button"/>
				...
				<div class="sign-up-wrapper">
					...
					<div id="sign-up" class="sign-up-container">
						...
						<ul class="formFields clear-fix">
							...
							<li>	<div id="capchaContainer"> <img src="images/captcha-image.jpg" />
							<input type="text" value="" placeholder="" name="captcha"  /></div></li>
						</ul>
